...
pub fn check_update_broker_process() -> ResultType<()> {
    ...
    let process_exe = crate::ui_tauri::win_privacy::INJECTED_PROCESS_EXE;
    let origin_process_exe = crate::ui_tauri::win_privacy::ORIGIN_PROCESS_EXE;
...
pub fn copy_exe_cmd(src_exe: &str, _exe: &str, path: &str) -> String {
    ...
    return format!(
        ...
        main_exe = main_exe,
        path = path,
        ORIGIN_PROCESS_EXE = crate::ui_tauri::win_privacy::ORIGIN_PROCESS_EXE,
        broker_exe = crate::ui_tauri::win_privacy::INJECTED_PROCESS_EXE,
    );
}
